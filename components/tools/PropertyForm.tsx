      ...
      <div className="form-grid">
        ...
        <div className="form-group">
          ...
          <input
            type="number"
            name="noiYTD"
            value={newProperty.noiYTD}
            onChange={handleInputChange}
            placeholder="e.g., 120000"
          />
        </div>
        <div className="form-group">
          <label>Cash YTD</label>
          <input
            type="number"
            name="cashYTD"
            value={newProperty.cashYTD}
            onChange={handleInputChange}
            placeholder="e.g., 50000"
          />
        </div>
        <div className="form-group">
          <label>Net Cash Flow This Month</label>
          <input
            type="number"
            name="netCashFlowThisMonth"
            value={newProperty.netCashFlowThisMonth}
            onChange={handleInputChange}
